...
declare @start_date as date = EPIC_UTIL.EFN_DIN('2011-01-01')
declare @end_date as date = EPIC_UTIL.EFN_DIN('2016-03-31')
...
select  *,
	  ...
	  ,@start_date as START_DATE
	   ...
	   ,case when cpt_code in ('99281', '99282', '99283', '99284', '99285', '99291') then procedure_quantity else 0 end as 'Mercy Visits' -- exclude cpt code 99292
...
and loc.gl_prefix = '6608'
and dep.gl_prefix = '795320'
and detail_type in (1,10)
and cpt_code in ('99281', '99282', '99283', '99284', '99285', '99291', '99292')
and perf.prov_id in ('1608522', '1608974', '1712459', '1674860', '1607065', '1627942', '1610803')
