...
where post_date >= '1/1/2011'
--and post_date <= '12/31/2011'
and detail_type in (1,10)
and t.serv_area_id in (11,13,16,17,18,19)
)trans
)b

group by year, loc_gl_prefix, dep_gl_prefix, department_name, prov_type
order by year, loc_gl_prefix, dep_gl_prefix, department_name, prov_type