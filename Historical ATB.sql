...
FROM (
	SELECT clarity_sa.serv_area_name
		,coalesce((cast(clarity_tdl_age.dept_id as varchar)), '000000000') AS 'Company Code'
	...
	LEFT JOIN clarity_sa ON clarity_tdl_age.serv_area_id = clarity_sa.serv_area_id
