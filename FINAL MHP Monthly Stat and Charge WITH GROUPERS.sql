...
select  
       ...
       pos.rpt_grp_one as 'POS_ID', 
	   pos.rpt_grp_two as 'POS_NAME',
       t.INVOICE_NUMBER, 
       t.CLM_CLAIM_ID, 
       t.PAT_AGING_DAYS, 
       t.INS_AGING_DAYS, 
...
LEFT OUTER JOIN CLARITY.dbo.ZC_LOC_RPT_GRP_10 sa on sa.rpt_grp_ten = loc.rpt_grp_ten
...
and loc.rpt_grp_ten in (11,13,16,17,18,19,21)
)trans