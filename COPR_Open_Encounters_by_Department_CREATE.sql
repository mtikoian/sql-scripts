...
********************************************************************************
*/
drop table ClarityCHPUTil.rpt.PB_COPR_Encounters_Detail
create table ClarityCHPUTil.rpt.PB_COPR_Encounters_Detail (
 REGION nvarchar(20),
 VISIT_PROVIDER_ID nvarchar(20),
 VISIT_PROVIDER nvarchar(100),
 DEPARTMENT_ID nvarchar(20),
 DEPARTMENT_NAME nvarchar(100),
 DATE date,
 YEAR_MONTH int,
 MONTH_YEAR nvarchar(25),
 OPEN_ENCOUNTERS int
)
...
DECLARE @start_date as date = EPIC_UTIL.EFN_DIN('mb-12')
		,@end_date as date = EPIC_UTIL.EFN_DIN('me-1')

WHILE (@start_date < = @end_date)
BEGIN
    PRINT @start_date
	insert into ClarityCHPUtil.rpt.PB_COPR_Encounters_Detail
