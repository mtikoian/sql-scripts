...
,edg.ref_bill_code as ICD9_Diagnosis_Code
,tdx.line as Sequence_Number
,'Epic' as Source_System


from ARPB_TRANSACTIONS arpb_tx
inner join V_ARPB_CODING_DX tdx on arpb_tx.tx_id=tdx.tx_id and tdx.line = '1'  --we only want the principal DX
inner join clarity_edg edg on tdx.dx_id=edg.dx_id and edg.REF_BILL_CODE_SET_C= '1' --1	ICD-9-CM
