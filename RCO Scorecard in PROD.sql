...
--declare @12month as date = EPIC_UTIL.EFN_DIN('{?12 Month}') 
...
(SELECT case
              ...
              ("CLARITY_TDL_TRAN"."CPT_CODE">='96150' AND "CLARITY_TDL_TRAN"."CPT_CODE"<='96154' OR 
				...
				"CLARITY_TDL_TRAN"."CPT_CODE"='90791' OR 
				"CLARITY_TDL_TRAN"."CPT_CODE"='90792' OR 
				"CLARITY_TDL_TRAN"."CPT_CODE"='99495' OR 
				"CLARITY_TDL_TRAN"."CPT_CODE"='99496' OR 
...
-->>>>>>>>  Calculation for Final Denial  <<<<<<<<<<<
              ...
              sum(case when(("CLARITY_EAP_MATCH"."PROC_CODE" = '4017'  or "CLARITY_EAP_MATCH"."PROC_CODE" = '4018' or "CLARITY_EAP_MATCH"."PROC_CODE" = '4019' or "CLARITY_EAP_MATCH"."PROC_CODE" = '4020' or "CLARITY_EAP_MATCH"."PROC_CODE" = '4021' or "CLARITY_EAP_MATCH"."PROC_CODE" = '3011' or "CLARITY_EAP_MATCH"."PROC_CODE" = '3012' or "CLARITY_EAP_MATCH"."PROC_CODE" = '3013' or "CLARITY_EAP_MATCH"."PROC_CODE" = '3014' or "CLARITY_EAP_MATCH"."PROC_CODE" = '3015' or "CLARITY_EAP_MATCH"."PROC_CODE" = '3018' or "CLARITY_EAP_MATCH"."PROC_CODE" = '3019' or "CLARITY_EAP_MATCH"."PROC_CODE" = '3052' or "CLARITY_EAP_MATCH"."PROC_CODE" = '5036') ) then "CLARITY_TDL_TRAN"."AMOUNT" 
...
--7/31/16 added 1312
WHERE  ("CLARITY_TDL_Tran"."SERV_AREA_ID" in (11,13,16,17,18,19,21,1312)) AND 
              ("CLARITY_TDL_Tran"."POST_DATE">=@start_date AND 
               "CLARITY_TDL_Tran"."POST_date"<=@end_date)
...
--7/31/16 added 1312
WHERE  ("CLARITY_TDL_AGE"."SERV_AREA_ID" in (11,13,16,17,18,19,21,1312)) AND 
              ("CLARITY_TDL_AGE"."POST_DATE">=@start_date AND 
               "CLARITY_TDL_AGE"."POST_date"<=@end_date)
...
WHERE  ("V_SCHED_APPT"."APPT_STATUS_C"=2 OR "V_SCHED_APPT"."APPT_STATUS_C"=6) AND
              ("V_SCHED_APPT"."CONTACT_DATE">=@start_date AND 
               "V_SCHED_APPT"."CONTACT_DATE"<=@end_date) AND 
               "CLARITY_DEP"."SERV_AREA_ID" in (11,13,16,17,18,19,21,1312) and ("V_SCHED_APPT"."COPAY_DUE" <> 0) and 
               ("V_SCHED_APPT"."LOC_ID" <> '11108' and 
               "V_SCHED_APPT"."LOC_ID" <> '11114111' and 
               "V_SCHED_APPT"."LOC_ID" <> '11104' and 
               "V_SCHED_APPT"."LOC_ID" <> '11105' and 
               "V_SCHED_APPT"."LOC_ID" <> '13103' and 
               "V_SCHED_APPT"."LOC_ID" <> '18101'and 
               "V_SCHED_APPT"."LOC_ID" <> '11110'and 
               "V_SCHED_APPT"."LOC_ID" <> '18106' and 
               "V_SCHED_APPT"."LOC_ID" <> '13101' and 
               "V_SCHED_APPT"."LOC_ID" <> '18111' and 
               "V_SCHED_APPT"."LOC_ID" <> '13102'and 
               "V_SCHED_APPT"."LOC_ID" <> '13103' and 
               "V_SCHED_APPT"."LOC_ID" <> '11107'and 
               "V_SCHED_APPT"."LOC_ID" <> '11130'and 
               "V_SCHED_APPT"."LOC_ID" <> '11129'and 
               "V_SCHED_APPT"."LOC_ID" <> '16101'and 
               "V_SCHED_APPT"."LOC_ID" <> '18107'and 
               "V_SCHED_APPT"."LOC_ID" <> '18108'and 
               "V_SCHED_APPT"."LOC_ID" <> '18109'and 
               "V_SCHED_APPT"."LOC_ID" <> '18112'and 
               "V_SCHED_APPT"."LOC_ID" <> '18113'and 
               "V_SCHED_APPT"."LOC_ID" <> '118117'and 
               "V_SCHED_APPT"."LOC_ID" <> '18118'and 
               "V_SCHED_APPT"."LOC_ID" <> '19104' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13105161' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13105154'  and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13105187' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13105174' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '1301192' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13101186' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13101187' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13101191' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13103116' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13103164' and
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13103165' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '13103166' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '131031161' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16102050' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16106108' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16106112' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16107104' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16108104' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16109113' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16109115' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16111101' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16102042' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16102043' and 
               "V_SCHED_APPT"."DEPARTMENT_ID" <> '16102028' ) and
...
( -- NOTE:   This SQL must be ran as close to the 1st as possible.  It can only report a point in time.
 ...
 SELECT 
              Case
					 ...
					 when "CLARITY_LOC"."SERV_AREA_ID" = '1312' then 'Summa'
...
-->>>>>>>>  Calculation for Open Encounters < 8 days  <<<<<<<<<<<
              sum(Case
                     When datediff(day,"PAT_ENC"."CONTACT_DATE",@end_date)<8 Then 1
              End) as "< 8 Days",

-->>>>>>>>  Calculation for Open Encounters 8 - 30 days  <<<<<<<<<<<
              sum(Case
                     When datediff(day,"PAT_ENC"."CONTACT_DATE",@end_date)>7 and datediff(day,"PAT_ENC"."CONTACT_DATE",@end_date)<31 Then 1
              End) as "8 - 30 Days",

-->>>>>>>>  Calculation for Open Encounters 31 - 90 days  <<<<<<<<<<<
              sum(Case
                     When datediff(day,"PAT_ENC"."CONTACT_DATE",@end_date)>30 and datediff(day,"PAT_ENC"."CONTACT_DATE",@end_date)<91 Then 1
              End) as "31 - 90 Days",

-->>>>>>>>  Calculation for Open Encounters 91 - 365 days  <<<<<<<<<<<
              sum(Case
                     When datediff(day,"PAT_ENC"."CONTACT_DATE",@end_date)>90 and datediff(day,"PAT_ENC"."CONTACT_DATE",@end_date)<366 Then 1
              End) as "91 - 365 Days"
...
WHERE  "CLARITY_LOC"."SERV_AREA_ID" in (11,13,16,17,18,19,21,1312) AND 
              ...
              ("PAT_ENC"."CONTACT_DATE">=@12month AND 
...
--            c.) Check for posting in previous months (If so exclude)
...
--                   convert(decimal(18,2),round(SUM("Days Lag")/sum("Distinct Count"),2)) as "Avg Lag Days"

fROM (
SELECT        case
                     when "ORG_TRANS"."LOC_ID" in ('11106','11123','11124') then 'Springfield Market'
                     when "ORG_TRANS"."SERV_AREA_ID" = '11' then 'Cincinnati Market'					 
                     when "ORG_TRANS"."SERV_AREA_ID" = '13' then 'Youngstown Market'
					 when "ORG_TRANS"."SERV_AREA_ID" = '1312' then 'Summa'
                     when "ORG_TRANS"."SERV_AREA_ID" = '16' then 'Lima Market'
                     when "ORG_TRANS"."SERV_AREA_ID" = '17' then 'Lorain Market'
                     when "ORG_TRANS"."LOC_ID" = '18120' then 'Defiance Market'
                     when "ORG_TRANS"."LOC_ID" = '18121' then 'Defiance Market'
                     when "ORG_TRANS"."SERV_AREA_ID" = '18' then 'Toledo Market'
                     when "ORG_TRANS"."LOC_ID"  in ('19101','19102','19105','19106') then 'Kentucky Market'
                     when "ORG_TRANS"."SERV_AREA_ID" = '21' then 'Healthspan Market'
              end as Market,
--                   "ORG_TRANS"."POS_ID",
                     "C_POS"."POS_NAME",
                     "patient"."PAT_MRN_ID",
                     "ORG_TRANS"."CHARGE_SLIP_NUMBER",
                     "ORG_TRANS"."PAT_ENC_CSN_ID" AS "ORIG_CSN",
                     "ORG_TRANS"."PAT_ID" AS "ORIG_PATID",
                     "Matched_ARPB_TRANS"."PAT_ENC_CSN_ID" AS "MATCHED_CSN",
                     "ORG_TRANS"."ORIG_SERVICE_DATE",
                     "ORG_TRANS"."POST_DATE",
                     min("Matched_ARPB_TRANS"."POST_DATE") as "Earliest Post Date",
-->>>>>>>>  Calculation for Total Charges  <<<<<<<<<<<

            SUM(case when("ORG_TranS"."DETAIL_TYPE" = 1 or "ORG_TranS"."DETAIL_TYPE" = 10)
                     Then "ORG_tranS"."AMOUNT"
            end) AS "Total Charges",

                     case
--                 when isnull ("ORG_TRANS"."PAT_ENC_CSN_ID",99) = 99 then datediff(day,"ORG_TRANS"."ORIG_SERVICE_DATE","ORG_TRANS"."POST_DATE")
                           when "ORG_TRANS"."POST_DATE" = min("Matched_ARPB_TRANS"."POST_DATE") then datediff(day,"ORG_TRANS"."ORIG_SERVICE_DATE","ORG_TRANS"."POST_DATE")
                     end as "Days Lag",
                     case
                           when "ORG_TRANS"."POST_DATE" = min("Matched_ARPB_TRANS"."POST_DATE") then 1
                           when "ORG_TRANS"."POST_DATE" = "ORG_TRANS"."ORIG_SERVICE_DATE" then 1
--                         when isnull ("ORG_TRANS"."PAT_ENC_CSN_ID",99) = 99 then 1
                           else 0
                     end as "Distinct Count"

FROM          ((("Clarity"."dbo"."CLARITY_TDL_TRAN" "ORG_TRANS"  LEFT OUTER JOIN "Clarity"."dbo"."ARPB_TRANSACTIONS" "Matched_ARPB_TRANS" ON "ORG_TRANS"."INT_PAT_ID"="Matched_ARPB_TRANS"."PATIENT_ID" and "ORG_TRANS"."ORIG_SERVICE_DATE"="Matched_ARPB_TRANS"."SERVICE_DATE") 
                                                                                                         LEFT OUTER JOIN "Clarity"."dbo"."patient" "Patient" ON "ORG_TRANS"."INT_PAT_ID" = "Patient"."PAT_ID")
                                                                                                         LEFT OUTER JOIN "Clarity"."dbo"."CLARITY_POS" "C_POS" ON "ORG_TRANS"."POS_ID" = "C_POS"."POS_ID")

WHERE         ("ORG_TRANS"."POST_DATE">=@start_date and
                     "ORG_TRANS"."POST_DATE"<=@end_date) and 
                      "ORG_TRANS"."SERV_AREA_ID" in (11,13,16,17,18,19,21,1312) and
                     ("ORG_TRANS"."DETAIL_TYPE" = 1 OR "ORG_TRANS"."DETAIL_TYPE" = 10)
...
GROUP BY      case
                     ...
                     "patient"."PAT_MRN_ID",
                     "ORG_TRANS"."CHARGE_SLIP_NUMBER",
                     "ORG_TRANS"."PAT_ENC_CSN_ID",
                     "ORG_TRANS"."PAT_ID",
                     "Matched_ARPB_TRANS"."PAT_ENC_CSN_ID",
                     "ORG_TRANS"."ORIG_SERVICE_DATE",
                     "ORG_TRANS"."POST_DATE"
