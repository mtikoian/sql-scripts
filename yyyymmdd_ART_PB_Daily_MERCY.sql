...
DECLARE @START_DATE AS DATE = EPIC_UTIL.EFN_DIN('12/1/2016')
DECLARE @END_DATE AS DATE = EPIC_UTIL.EFN_DIN('12/1/2016')
...
(
SELECT    coalesce((cast(tdl.dept_id as varchar)), '000000000') AS COMPANY_CODE
