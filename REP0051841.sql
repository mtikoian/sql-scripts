select distinct
arpb.DEPARTMENT_ID [ClinicCode]
,arpb.SERVICE_AREA_ID [HSPCODE]
,pos.pos_type [PlaceOfService]
,zc_sex.NAME [Gender]
,arpb.SERVICE_DATE [ServiceDate]
,ser2_bill.NPI [PhysicianNPI]
,ser_bill.PROV_NAME [Physician Name]
,zc_spec_bill.NAME [PhysicianSpecialty]
,fc.FINANCIAL_CLASS_NAME [FinClass]
,epm.PAYOR_NAME [Payer]
,eap_ot.CPT_CODE [CPT]
,arpb.MODIFIER_ONE [CPTMod1]
,arpb.MODIFIER_TWO [CPTMod2]
,arpb.MODIFIER_THREE [CPTMod3]
,arpb.MODIFIER_FOUR [CPTMod4]
,edg1.DIAGNOSIS_CODE [PrimaryDiag]
,edg2.DIAGNOSIS_CODE [Diag2]
,edg3.DIAGNOSIS_CODE [Diag3]
,edg4.DIAGNOSIS_CODE [Diag4]
--,hsp_tx.TX_AMOUNT [Charge]
,arpb.amount [arpb_amount]
,eap.PROC_CODE [CDMNumber]
,arpb.PROCEDURE_QUANTITY [Units]
...
where cast(hsp_act.ACCT_ZERO_BAL_DT as date) between dateadd("d",1,CLARITY_REPORT.RELATIVE_START_DATE('{?StartDate}'))
